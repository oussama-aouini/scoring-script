...
green_house_gas_emissions_count = 0
emission_of_solid_or_liquid_waste_count = 0
emission_of_other_pollutant_gases_count = 0
recycling_and_use_of_waste_count = 0
Water_utilization_and_eficiency_count = 0
energy_eficiency_count = 0
Status_of_environmental_management_system_count = 0
terms_and_conditions_applicable_to_suppliers_count = 0
RndD_count = 0
tic_count = 0

iso_14001_index = 0
gri_index = 0
green_house_gas_emissions_index = 0
emission_of_solid_or_liquid_waste_index = 0
emission_of_other_pollutant_gases_index = 0
recycling_and_use_of_waste_index = 0
Water_utilization_and_eficiency_index = 0
energy_eficiency_index = 0
Status_of_environmental_management_system_index = 0
terms_and_conditions_applicable_to_suppliers_index = 0
RndD_index = 0
tic_index = 0
